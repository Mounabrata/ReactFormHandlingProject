...
function Card({ user, handleRemove, id }) {
  return (
    <div className="w-52 h-full bg-zinc-50 rounded-lg flex flex-col items-center p-2">
      ...
      <button
        ...
        className="px-3 py-1 bg-red-600 text-sm text-white rounded-md mt-4 font-semibold"
      >
        Remove
      </button>
    </div>
